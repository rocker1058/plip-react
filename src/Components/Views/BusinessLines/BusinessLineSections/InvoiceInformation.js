...
const InvoiceInformation = forwardRef(({ onPropertyChange, companyDependant, customInvoiceData = {}, companyInvoiceData = {} }, ref) => {
	...
	}, [ companyDependant, (customInvoiceData[year] || {}).baseMeasurement, (customInvoiceData[year] || {}).lineMeasurement, (customInvoiceData[year] || {}).paperType, (customInvoiceData[year] || {}).invoicingCompany ])

	const selectedInvoiceData = companyDependant ? companyInvoiceData : customInvoiceData
	const { 
		baseMeasurement, 
		lineMeasurement, 
		paperType, 
				...
				<div className="col-md-6">
					<div className="form-group row justify-content-start">
						<input
							className="mr-3"
							type="checkbox"
							name="companyDependant"
							checked={companyDependant}
							onChange={e => onPropertyChange('companyDependant', e.target.checked)}
							disabled={!isPlip}
						/>
						<label className="col-form-label" htmlFor="inputName">Utilizar medidas del establecimiento</label>
					</div>
					...
					<div className="form-group row">
						...
						<input
							...
							disabled={companyDependant || !isPlip}
...
InvoiceInformation.propTypes = {
	...
	companyDependant: PropTypes.bool,
