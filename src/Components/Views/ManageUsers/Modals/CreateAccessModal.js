...
import { UPDATE_USER_ACCESS, GET_ROLES, GET_PERMISSIONS } from '../GraphQL'
...
function CreateAccessModal({ visible, setVisible, company, user, onAccessCreated }){
	...
	const { Modal } = useModal({ identifier: 'createUserModal', visible, setVisible, clean: resetModal })
	...
	return (
		<Modal>
			<form className="container" onSubmit={onSubmit}>
				<div className="row">
					<h2 className=" col-12 text-center">Crear nuevo acceso</h2>
				</div>
				...
				<div className="row">
					...
					<div className="container-button">
						<p className='line-modal'></p>
						<CustomForm.LoadingButton loading={loadingButton} disabled={Object.keys(errors).length > 0} className="btn btn-lg btn-primary btn-block button">Crear acceso</CustomForm.LoadingButton>
					</div>
				</div>
			</form>
		</Modal>
...
CreateAccessModal.propTypes = {
	user: PropTypes.func,
	visible: PropTypes.bool,
	setVisible: PropTypes.func,
	company: PropTypes.string,
	onAccessCreated: PropTypes.func,
}
