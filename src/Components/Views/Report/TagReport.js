			...
			<div className="d-none">
				...
				<table id="table-to-xls">
					...
					<tr>
						...
						<th style={{ fontWeight: 'normal' }}>{this.props.report.totals.totalInvoices}</th>
					</tr>
					<tr>
						<th>Total papel ahorrado</th>
						<th style={{ fontWeight: 'normal' }}>{this.props.report.totals.formattedTotal.number}</th>
						<th style={{ fontWeight: 'normal' }}>{this.props.report.totals.formattedTotal.unit}</th>
					</tr>
				</table>
			</div>
		)
